...
def start_train(train_loader, valid_loader, test_loader, modellist, device, criterion, optimizer, scheduler, num_epochs, resume, stat):
    ...
    if stat == 'train':
        ...
        for epoch in range(1 + resume, num_epochs + 1):
            ...
            if v_aucdic['macro'] > best_auc:
                best_auc = v_aucdic['macro']
                torch.save(model.state_dict(), os.path.join(
                    checkpoints, 'best_auc.pt')
                )            
                auc_epoch = epoch
            ...
            if v_Acc > best_acc:
                best_acc = v_Acc
                torch.save(model.state_dict(), os.path.join(
                    checkpoints, 'best_acc.pt')
                )
            if epoch % 5 == 0:
                torch.save(model.state_dict(), os.path.join(checkpoints, '%i.pt' % epoch))  
                ...
                torch.save(checkpoint_resume,os.path.join(checkpoints, 'checkpoint_resume_%s' % str(epoch)))
...
if __name__ == '__main__':
    ...
    # 15  CUDA_VISIBLE_DEVICES=3,4  python /home/21/zihan/Storage/lympho/code/train_lym3.py --TrainFolder "/data15/data15_5/dexia/code_ctrans_ntl/lympho_bag/img_lym_120_40x_liuyuan"  --Comment 'lr0.001,Decay0.0005,SGD,cross,Pre,256,rs224,20x,alpha0.5,3mix' --Pretrain --FoldN 1 --BatchSize 32 --Epoch 100 --Resume 0 --Stat test
    # 15  CUDA_VISIBLE_DEVICES=1,3  python /home/21/zihan/Storage/lympho/code/train_lym3.py --TrainFolder "/home/21/zihan/Storage/lympho/patch_tianjin_ntl_test/catimg_lympho_40"  --Comment 'lr0.001,Decay0.0005,SGD,cross,Pre,256,rs224,20x,alpha0.5,3mix' --Pretrain --FoldN 1 --BatchSize 32 --Epoch 100 --Resume 0 --Stat test
    # 15  CUDA_VISIBLE_DEVICES=1,3  python /home/21/zihan/Storage/lympho/code/train_lym3.py --TrainFolder "/home/21/zihan/Storage/lympho/patch_tianjin_ntl_test/catimg_lympho_40"  --Comment 'lr0.001,Decay0.0005,SGD,cross,Pre,256,rs224,20x,alpha0.5,3mix' --Pretrain --FoldN 1 --BatchSize 32 --Epoch 100 --Resume 0 --Stat test
    # 15  CUDA_VISIBLE_DEVICES=2,4  python /home/21/zihan/Storage/lympho/code/train_lym3.py --TrainFolder "/home/21/zihan/Storage/lympho/lympho_analysis/catimg_lympho_40/CRC"  --Comment 'lr0.001,Decay0.0005,SGD,cross,Pre,256,rs224,20x,alpha0.5,3mix' --Pretrain --FoldN 1 --BatchSize 32 --Epoch 100 --Resume 0 --Stat test

    # 15  CUDA_VISIBLE_DEVICES=2,3  python /home/21/zihan/Storage/lympho/code/train_lym3.py --TrainFolder " /home/21/zihan/Storage/lympho/patch_tianjin_ntl_test/catimg_lympho_40"  --Comment 'lr0.001,Decay0.0005,SGD,cross,Pre,256,rs224,20x,alpha0.5,3mix' --Pretrain --FoldN 1 --BatchSize 32 --Epoch 100 --Resume 0 --Stat test

    # 15  CUDA_VISIBLE_DEVICES=2,3  python /home/21/zihan/Storage/lympho/code/train_lym3.py --TrainFolder "/home/21/zihan/Storage/lympho/splited/splited_712_noverlap_20x"  --Comment 'test_problem' --Pretrain --FoldN 1 --BatchSize 32 --Epoch 200 --Resume 0 --Stat test
    # 15  CUDA_VISIBLE_DEVICES=4,6  python /home/21/zihan/Storage/lympho/code/train.py --Task 'lym' --TrainFolder "/home/21/zihan/Storage/lympho/splited/splited_712_noverlap_10x"  --Comment 'lr0.001,Decay0.0005,SGD,cross,Pre,256,rs224,10x,alpha0.5,3mix' --Pretrain --FoldN 1 --BatchSize 128 --Epoch 200 --Resume 0
    ...
    if args.stat == 'test':
        ...
        '''ptpathlist = ['/data15/data15_5/dexia/code_ctrans_ntl/checkpoints_ntl/2023_11_27_classification,resnet18/resnet18,256,seed0,fold1/FINAL.pt',
                      '/data15/data15_5/dexia/code_ctrans_ntl/checkpoints_ntl/2023_11_28_classification,resnet18/resnet18,256,seed0,fold2/FINAL.pt',
                      '/data15/data15_5/dexia/code_ctrans_ntl/checkpoints_ntl/2023_11_28_classification,resnet18/resnet18,256,seed0,fold3/FINAL.pt',
                      '/data15/data15_5/dexia/code_ctrans_ntl/checkpoints_ntl/2023_11_28_classification,resnet18/resnet18,256,seed0,fold4/FINAL.pt',
                      '/data15/data15_5/dexia/code_ctrans_ntl/checkpoints_ntl/2023_11_28_classification,resnet18/resnet18,256,seed0,fold5/FINAL.pt']'''
